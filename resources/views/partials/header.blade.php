<div id="page-header" class="page-header page-header-light app-page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="page-header-icon"><i class="icon-grid6"></i></span> <span class="font-weight-semibold">@yield('page_title')</span></h4>
